...
<div class="container-fluid">
  ...
  <div class="row mt-5 justify-content-center pb-3">
    <div class="col-10 col-lg-4 m-3 text-danger tourne_positif">
        <div class="card border border-5 border-danger bg-success">
    ...
    <div class="col-10 col-lg-4 m-3 text-success tourne">
        <div class="card border border-5 border-success bg-danger">
            ...
            <div class="dancing-script-menu" style="font-size: 1.2rem; color:black;">
                ...
                <a href="#" class="card-link btn btn-outline-warning rounded-0 mt-2">Plats</a>
                <a href="#" class="card-link btn btn-outline-warning rounded-0 mt-2">Desserts</a>
            </div>
        </div>
    </div>
        ...
        <div class="col-10 col-lg-4 m-3 text-success tourne">
            <div class="card  border border-5 border-success bg-danger">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="card-link btn btn-outline-warning rounded-0 mt-2">Liste</a>
                </div>
            </div>
        </div>
