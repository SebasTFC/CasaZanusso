...
<div class="container-fluid">
    <div class="mb-5 text-center">
        <div class="row mt-3 justify-content-center">
            ...
            <h1 class="dancing-script-menu bg-success p-2" style="font-size: 3rem;color:yellow;">Liste de nos desserts:</h1>
        </div>
    </div>

    <?php
       $recupPlats = $bd->query("SELECT * FROM plats WHERE id_sorteplat= 2");
