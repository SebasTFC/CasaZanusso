...
<div class="container-fluid my-5"> 
    <div class="row justify-content-between">
        <div class="col-lg-4 col-12">
            ...
            <h2 class="bg-success p-2 text-center">Créer/Modifier un plat</h2>    
                ...
                <div class="form-group p-1">
                    ...
                    <div class="container row justify-content-center">
                        <div class=" col-6 form-check">
                            <input class="form-check-input" type="radio" name="detail_plat" id="detail_plat" value="Prix au kilo" checked>
                            <label class="form-check-label" for="detail_plat">Prix au kilo:</label>
                        </div>
                        <div class="col-6 form-check">
                            <input class="form-check-input" type="radio" name="detail_plat" id="detail_plat" value="Prix par personne">
                ...
                <div class="col-lg-8 col-12">
                    <div class="border p-3">
                        ...
                        <div class="text-center mt-3">
                            <a href="/admin/header_admin.php" class="btn btn-secondary text-dark">Retour</a>
                        </div>
                    </div> 
                </div>
        </div>
